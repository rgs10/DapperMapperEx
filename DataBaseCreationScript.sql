USE [master]
GO
/****** Object:  Database [TestDB1]    Script Date: 17/09/2016 23:31:40 ******/
...
GO
ALTER DATABASE [TestDB1] SET COMPATIBILITY_LEVEL = 130
GO
...
GO
ALTER DATABASE [TestDB1] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [TestDB1] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [TestDB1] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [TestDB1] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [TestDB1] SET ARITHABORT OFF 
GO
...
GO
ALTER DATABASE [TestDB1] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [TestDB1] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [TestDB1] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [TestDB1] SET QUOTED_IDENTIFIER OFF 
GO
